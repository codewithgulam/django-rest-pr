...
!(function(e, t) {
    ...
    function g(e) {
        ...
        return (
            ...
            Math.abs(t.height - r) <= 1 && (r = t.height), { x: e.offsetLeft, y: e.offsetTop, width: n, height: r }
        );
    }
        ...
        return r === H ?
            ...
            I(
                (function(e) {
                    ...
                    return (
                        "rtl" === m(o || n).direction &&
                        (f += i(n.clientWidth, o ? o.clientWidth : 0) - a), { width: a, height: s, x: f, y: c }
                    );
                })(d(e))
            );
    }
                    ...
                    a = S.reduce(function(e, n) {
                        return (
                            (e[n] = (function(e, t, n) {
                                ...
                                return (
                                    (a = a || 0),
                                    (s = (s || 0) * o), [P, L].indexOf(r) >= 0 ? { x: s, y: a } : { x: a, y: s }
                                );
                            })(n, t.rects, i)),
                            e
                        );
